# InvestorClaw Architecture — Code Organization

**Audience**: Developers and contributors  
**See also**: [ARCHITECTURE_INDEX.md](ARCHITECTURE_INDEX.md) for architecture guide | [ARCHITECTURE_DECISIONS.md](ARCHITECTURE_DECISIONS.md) for design principles
